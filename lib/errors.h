/*
 * errors.h - exhaustive list of all error codes and messages for libcgcef.
...
__err__(ERROR_WRONLY,		_("Request error: cntl(CGCEF_C_FDREAD) on write-only file"))
__err__(ERROR_INVALID_CMD,	_("Request error: invalid CGCEF_C_* argument"))
...
__err__(ERROR_UNKNOWN_VERSION,	_("Request error: unknown CGCEF version"))
__err__(ERROR_CMDMISMATCH,	_("Request error: CGCEF_C_* argument does not match"))
...
__err__(ERROR_NOTCGCEF,		_("Request error: not an CGCEF file"))
__err__(ERROR_CLASSMISMATCH,	_("Request error: class file/memory mismatch"))
__err__(ERROR_UNKNOWN_TYPE,	_("Request error: invalid CGCEF_T_* argument"))
...
__err__(ERROR_UNKNOWN_CLASS,	_("Request error: unknown CGCEF class"))
__err__(ERROR_CGCEFSCNMISMATCH,	_("Request error: section does not belong to file"))
...
__err__(ERROR_RDONLY,		_("Request error: update(CGCEF_C_WRITE) on read-only file"))
...
__err__(ERROR_VERSION_UNSET,	_("Sequence error: must set CGCEF version first"))
__err__(ERROR_NOEHDR,		_("Sequence error: must create CGCEF header first"))
...
__err__(ERROR_TRUNC_EHDR,	_("Format error: CGCEF header truncated"))
...
__err__(ERROR_MEM_CGCEF,		_("Memory error: cgcef descriptor"))
...
__err__(ERROR_MEM_EHDR,		_("Memory error: CGCEF header"))
...
__err__(ERROR_BADVALUE,		_("GCGCEf error: value out of range"))
__err__(ERROR_BADINDEX,		_("GCGCEf error: index out of range"))
__err__(ERROR_BADTYPE,		_("GCGCEf error: type mismatch"))
__err__(ERROR_MEM_SYM,		_("GCGCEf error: not enough memory for GCGCEf_Sym"))
__err__(ERROR_MEM_DYN,		_("GCGCEf error: not enough memory for GCGCEf_Dyn"))
__err__(ERROR_MEM_RELA,		_("GCGCEf error: not enough memory for GCGCEf_Rela"))
__err__(ERROR_MEM_REL,		_("GCGCEf error: not enough memory for GCGCEf_Rel"))
