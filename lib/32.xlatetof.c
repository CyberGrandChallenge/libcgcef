/*
 * 32.xlatetof.c - implementation of the cgcef32_xlateto[fm](3) functions.
 ...
 */
copy_type(addr_32,_,CGCEf32_Addr,copy_addr_11)
copy_type(half_32,_,CGCEf32_Half,copy_half_11)
copy_type(off_32,_,CGCEf32_Off,copy_off_11)
copy_type(sword_32,_,CGCEf32_Sword,copy_sword_11)
copy_type(word_32,_,CGCEf32_Word,copy_word_11)
copy_type(dyn_32,11,CGCEf32_Dyn,copy_dyn_11)
copy_type(ehdr_32,11,CGCEf32_Ehdr,copy_ehdr_11)
copy_type(phdr_32,11,CGCEf32_Phdr,copy_phdr_11)
copy_type(rela_32,11,CGCEf32_Rela,copy_rela_11)
copy_type(rel_32,11,CGCEf32_Rel,copy_rel_11)
copy_type(shdr_32,11,CGCEf32_Shdr,copy_shdr_11)
copy_type(sym_32,11,CGCEf32_Sym,copy_sym_11)
...
xlate32_11[/*encoding*/] = {
	...
	{ _cgcef_verdef_32L11_tom,  _cgcef_verdef_32L11_tof  },
	{ _cgcef_verneed_32L11_tom, _cgcef_verneed_32L11_tof },
	...
	{ 0,                0               },	/* there is no Xword */
#if __LIBCGCEF_SYMBOL_VERSIONS
	{ _cgcef_verdef_32M11_tom,  _cgcef_verdef_32M11_tof  },
	{ _cgcef_verneed_32M11_tom, _cgcef_verneed_32M11_tof },
#else /* __LIBCGCEF_SYMBOL_VERSIONS */
	{ 0,                0               },
	{ 0,                0               },
#endif /* __LIBCGCEF_SYMBOL_VERSIONS */
 ...
 */
size_t
_cgcef32_xltsize(const CGCEf_Data *src, unsigned dv, unsigned encode, int tof) {
 ...
 */
static CGCEf_Data*
cgcef32_xlate(CGCEf_Data *dst, const CGCEf_Data *src, unsigned encode, int tof) {
    CGCEf_Type type;
    int dv;
    int sv;
    size_t dsize;
 ...
 */
CGCEf_Data*
cgcef32_xlatetom(CGCEf_Data *dst, const CGCEf_Data *src, unsigned encode) {
    return cgcef32_xlate(dst, src, encode, 0);
}

CGCEf_Data*
cgcef32_xlatetof(CGCEf_Data *dst, const CGCEf_Data *src, unsigned encode) {
    return cgcef32_xlate(dst, src, encode, 1);
}
